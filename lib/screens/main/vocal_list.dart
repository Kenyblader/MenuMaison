...
import 'package:menu_maison/components/record_widget.dart';
...
class _AudiolistformState extends State<Audiolistform> {
  ...
  void initState() {
    super.initState();
    _askPermition(); // Super doit être appelé en premier
  ...
  _askPermition() async {
    if (await _speechToText.hasPermission) {
      ...
      print("la permission est accorde");
    } else {
      print("la permission est refuse");
    }
  }
